package com.hjw.user.controller;
...
import com.hjw.model.dto.user.*;
import com.hjw.model.entity.User;
import com.hjw.model.vo.LoginUserVO;
...
import static com.hjw.user.service.impl.UserServiceImpl.SALT;
...
public class UserController
{
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public R<Page<User>> listUserByPage(@RequestBody UserQueryRequest userQueryRequest, HttpServletRequest request
    )
    {
    ...
    public R<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest, HttpServletRequest request
    )
    {
    ...
    public R<Boolean> updateMyUser(@RequestBody UserUpdateMyRequest userUpdateMyRequest, HttpServletRequest request
    )
    {
